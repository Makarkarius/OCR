...
const assessorsModel = defineModel()

const removeAssessor = (arr, func) => {
  const newArr = []
...
<template>
  <div>
    <UserSearch v-model:show="isUserSearchModalActive" v-model:users="assessorsModel" />
